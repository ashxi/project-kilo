...
curl "https://github.com/googlefonts/opensans/blob/main/fonts/ttf/OpenSans-Regular.ttf?raw=true" > ../src/gfonts/ops1.ttf
curl "https://github.com/googlefonts/opensans/blob/main/fonts/ttf/OpenSans-Regular.ttf?raw=true" > ../src/gfonts/ops2.ttf
...
echo [3/3] Installing VSCode Fluent Icons...
